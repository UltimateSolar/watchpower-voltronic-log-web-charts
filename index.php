...
<body>
	<div id="div1" style="position: absolute; left: 0px; top: 0px; width: 100%; height: 100%;">
    	<div id="div2" style="position: relative; float: left; min-width: 100%;">
    		<?php echo "stats for selected dates: produced: ".$stats_kWh_produced."kWh, used: ".$stats_kWh_used."kWh, inverter (".$watts_used_by_inverter."W) used: ".$stats_kWh_used_by_inverter."kWh"; ?>
    	</div>
